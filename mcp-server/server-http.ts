...
registerAccountTools(mockServer as any, supabase);
registerContactTools(mockServer as any, supabase);
registerDealTools(mockServer as any, supabase);
registerPipelineTools(mockServer as any, supabase);
registerInteractionTools(mockServer as any, supabase);
registerSearchTools(mockServer as any, supabase);
