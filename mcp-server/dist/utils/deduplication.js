 ...
 */
export async function checkDuplicateContact(supabase, data) {
    const matches = [];
    ...
    if (data.first_name && data.last_name) {
        ...
        if (!error && nameMatches) {
            nameMatches.forEach((match) => {
                ...
                const sameAccount = (data.account_id && match.account_id === data.account_id) ||
 ...
 */
export async function checkDuplicateDeal(supabase, data) {
    const matches = [];
