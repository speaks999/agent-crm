...
export function StockTickerWidget({ config, onRemove, onResize, onSettings, onDragStart, isDragging }: WidgetProps) {
    ...
    return (
        ...
        >
            {isEditing ? (
                <div className="h-full flex flex-col" style={{ maxHeight: '320px' }}>
                    {/* Add new symbol */}
                    ...
                    <div className="flex-1 space-y-1 overflow-y-auto mt-3">
                        {symbols.length === 0 ? (
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary-glow transition-colors text-sm mt-3 flex-shrink-0"
                    >
                        <Check size={16} />
                        Done
                    </button>
